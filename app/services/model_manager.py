...
class ModelManager:
    ...
    def register_trained_model(
        ...
        try:
            ...
            model_info = ModelInfo(
                ...
                config_path=(
                    str(organized_config_path) if organized_config_path else None
                ),
            ...
            print(f"Registered model: {model_id} (version {version})", flush=True)
            return model_id
    ...
    def _generate_version(self, model_name: str) -> str:
        ...
        existing_models = [
            m for m in self.models_metadata.values() if m.name == model_name
        ]
